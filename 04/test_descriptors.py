...
class TestCustomList(unittest.TestCase):
    ...
    def test_not_changing_value(self):
        my_prepare = descriptors.ChessOpeningsPrepare(
            "e4 e5 kf3 kf6", "e4 c5", "e4 e6")
        with self.assertRaises(ValueError) as err:
            my_prepare.rus_opening = "e4 e5 kf3 kc6"
        ...
        self.assertEqual("e4 e5 kf3 kf6", my_prepare.rus_opening)
        self.assertEqual("e4 c5", my_prepare.sicilian_opening)
        self.assertEqual("e4 e6", my_prepare.fr_opening)
